    ...
    <section ref={HeroRef} style={{ opacity: 0 }}>
      <div className="w-[95vw] h-full bg-[url('/action-3195378.png')] bg-no-repeat bg-cover">
        <div className="w-full flex justify-end z-10 ">
          <div className="backdrop-blur-sm rounded-lg mt-6">
            <div className="mr-20 mt-20">
              ...
              <div className="max-w-4xl">
                <p className="text-white text-right">
                  ...
                  est vitae auctor consequat. Aliquam pretium suscipit
                  facilisis. Cras ornare ligula nulla, non fringilla lacus
                  tincidunt in. Aenean mattis id dui sed semper. Donec tincidunt
                  blandit nibh, ac fringilla mi pellentesque eget. Nulla sed
                  purus vitae mi consectetur dapibus. Nam est lacus, convallis
                  vitae egestas a, condimentum ac sapien.
                </p>
              </div>
            </div>
          </div>
